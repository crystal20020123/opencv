...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.analysis_button.grid(row=5, column=0,columnspan=2, padx=20, pady=10)
    ...
    def draw_image(self):
        ...
        for main_contour in main_list:
            ...
            for contour in contours:
                ...
                x, y, w, h = cv2.boundingRect(contour)
                if (2000> w*h > 30 and contour_include(main_contour,contour)):
